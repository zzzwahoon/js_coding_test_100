...
// 이 사실을 이용하여 음이 아닌 정수가 문자열 `number`로 주어질 때, 이 정수를 9로 나눈 나머지를 return하는 solution 함수를 작성해주세요.
...
const solution_2 = num => Number(BigInt(num) % 9n); 

console.log(solution('123')); // 6
console.log(solution('78720646226947352489')); // 2
console.log(solution_2('123')); // 6
console.log(solution_2('78720646226947352489')); // 2