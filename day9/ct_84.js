...
const solution_2 = (a, d, included) => 
  included.reduce((sum, bool, i) => bool ? sum + a + d * i : sum, 0);
...
console.log(solution_2(3, 4, [true, false, false, true, true])); // 37
console.log(solution_2(7, 1, [false, false, false, true, false, false, false])); // 10