...
const solution_2 = names => {
  const res = [];

  for (let i = 0; i < names.length; i++) {
    if (i % 5 === 0) res.push(names[i]);
  }
...
// functional
const solution_3 = names => names.filter((_, i) => i % 5 === 0);

console.log(solution(['nami', 'ahri', 'jayce', 'garen', 'ivern', 'vex', 'jinx'])); // ["nami", "vex"]
console.log(solution_2(['nami', 'ahri', 'jayce', 'garen', 'ivern', 'vex', 'jinx'])); // ["nami", "vex"]
console.log(solution_3(['nami', 'ahri', 'jayce', 'garen', 'ivern', 'vex', 'jinx'])); // ["nami", "vex"]