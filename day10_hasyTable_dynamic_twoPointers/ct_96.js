...
const solution_3 = nums => {
  const counts = nums.reduce((map, n) => 
...
console.log(solution_2([1, 2, 3, 3, 3, 4])); // 3
console.log(solution_2([1, 1, 2, 2])); // -1
console.log(solution_2([1])); // 1

console.log(solution_3([1, 2, 3, 3, 3, 4])); // 3
console.log(solution_3([1, 1, 2, 2])); // -1
console.log(solution_3([1])); // 1